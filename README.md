...
**日历页**：随时规划、修改或取消预定事件与周期事件，一周的安排一目了然。

![日历页](img/image-20260907163058452.png)

**计划页**：制定并随时调整计划，一份计划可以包含任意数量的关键事件；在日历上
安排时间时，能直接从计划里选取对应的事件。

![计划页](img/image-20260907163143697.png)

**奖励页**：平日/周末分别按完成时长结算点数，攒够了去兑换自己设定的奖励，把
"花钱犒赏自己"变成一件可管理的事。

![奖励页](img/image-20260907163201268.png)

**设置页**：切换显示语言和地区（目前支持中国大陆 / 美国 / 日本），调整点数
成长比例，或者给界面换一张喜欢的背景图。

![设置页](img/image-20260907163405936.png)

在线体验：[yiran201.github.io/Planto](https://yiran201.github.io/Planto/) ——
数据完全存在你本地浏览器里，不会上传到任何服务器，不用担心泄露；日常重度使用
还是建议按 [`DEPLOYMENT.md`](DEPLOYMENT.md) 本地部署。
