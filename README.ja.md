...
**「計画倒れ」しがちな人のための、カレンダー型の計画実行支援ツール。**
...
**カレンダー**：予定イベントや繰り返しイベントをいつでも計画・編集・キャンセルでき、
その週の予定が一目で分かります。

![カレンダーページ](img/image-20260907163058452.png)

**計画**：計画を作成していつでも編集でき、1つの計画には任意の数のキーイベントを
含められます。カレンダー上で予定を入れる際は、計画から対応するイベントを直接
選択できます。

![計画ページ](img/image-20260907163143697.png)

**報酬**：平日・週末それぞれの完了時間に応じてポイントが貯まり、自分で決めた
ご褒美リストと交換できます。「使って自分にご褒美をあげる」を管理可能な習慣に
変えられます。

![報酬ページ](img/image-20260907163201268.png)

**設定**：表示言語と地域を切り替え（中国・アメリカ・日本に対応）、ポイントの
成長率を調整したり、好きな背景画像を設定したりできます。

![設定ページ](img/image-20260907163405936.png)

オンラインで試す：[yiran201.github.io/Planto](https://yiran201.github.io/Planto/) ——
データはすべてお使いのブラウザのローカルに保存され、サーバーには一切送信されない
ため、漏洩の心配はありません。日常的にしっかり使うなら、
[`DEPLOYMENT.md`](DEPLOYMENT.md) を参照してのローカルデプロイをおすすめします。

現在このプロジェクトは最初のリリースの段階です。問題を見つけた場合は、お気軽に
DM でご連絡ください。
